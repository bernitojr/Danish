...
export function PodiumCard({ entry, rank }: PodiumCardProps) {
  const rankClass = {
    1: {
      ...
      badge:
        'bg-[hsl(var(--gold)/0.15)] text-[hsl(var(--gold))] border border-[hsl(var(--gold))] ',
      avatar:
    ...
    2: {
      ...
      badge:
        'bg-[hsl(var(--gold)/0.15)] text-[hsl(var(--silver))] border border-[hsl(var(--silver))] ',
      avatar:
    ...
    3: {
      ...
      badge:
        'bg-[hsl(var(--gold)/0.15)] text-[hsl(var(--bronze))] border border-[hsl(var(--bronze))] ',
      avatar:
